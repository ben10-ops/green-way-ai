const esiValue = 72;
const esiLabel = esiValue > 75 ? "High Risk" : esiValue > 50 ? "Moderate" : "Low Stress";
...
const factors = [
  { label: "Tourist Volume", value: "32,400", change: "+12%" },
  { label: "Avg Stay Duration", value: "3.2 days", change: "+0.4d" },
  { label: "Waste Factor", value: "1.8x", change: "+0.3x" },
  { label: "Infrastructure Cap.", value: "45,000", change: "—" },
];
